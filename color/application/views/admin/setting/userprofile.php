           ...
           <!-- end col -->
            ...
            <div class="col-md-6">
               ...
               <div class="card-box text-center">
                   ...
                   <div class="m-b-30">
                       <img src="<?php echo (($method=="edit")?(base_url('public/uploads/profiles/').$profile->image):base_url('public/admin/images/users/avatar-5.jpg')); ?>" class="rounded-circle img-thumbnail thumb-lg" alt="thumbnail" style="background: #c8cacb;">
                   </div>
