...
<html>
    <head>
        ...
        <script src="<?php echo base_url('public/admin/');?>pages/jquery.toastr.js" type="text/javascript"></script>
    ...
    <body class="bg-accpunt-pages">
        ...
        <section>
                                    ...
                                    <div class="account-logo-box">
                                        <div class="text-center">
                                            <a href="#" class="text-center">
                                                ...
                                                <img src=" <?php echo base_url('public/admin/images/').LOGO_BLACK; ?>" height="80">
                                            </a>
                                        </div>
                                    </div>
          ...
          <!-- END HOME -->
          <script type="text/javascript" src="<?php echo base_url('public/admin');?>/plugins/parsleyjs/parsley.min.js"></script>
