...
defined('FULL_NAME')   OR define('FULL_NAME', "RB RBTEXTILE PVT. LTD."); 
defined('COM_HEADER')   OR define('COM_HEADER', "Mfg. Cotton Sarees, Kitanga, Khanga & Dress Materials."); 
defined('ADDRESS1')    OR define('ADDRESS1', 'CHAMPRAJPUR ROAD, NEAR BHOJADHAR, JETPUR-360370');
defined('ADDRESS2')    OR define('ADDRESS2', 'Champrajpur Road, Near Bhojadhar, B/h. Mayur Plastic, JETPUR-360370'); 
defined('GST_NO')   OR define('GST_NO', "24AAJCR2380L1Z4"); 
defined('PAN_NO')   OR define('PAN_NO', "AAJCR2380L"); 
defined('MOBILE')   OR define('MOBILE', "87586 10170"); 
