...
defined('COMPANY_NAME')        OR define('COMPANY_NAME', "GURUKRUPA"); // company name
defined('TITLE')        	   OR define('TITLE', "GURUKRUPA || LARK INFOWAY"); // company name
...
defined('COMPANY')      	   OR define('COMPANY', "Gurukrupa"); // company name
