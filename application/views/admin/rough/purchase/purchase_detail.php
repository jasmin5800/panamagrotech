                ...
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <ol class="breadcrumb float-right">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo base_url('RoughPurchase/index');?>"><?php echo $page_title; ?></a></li>
                        </ol>
            ...
            <div class="row">
                <div class="col-12" style="">
                    <div class="card-box table-responsive" style="">
                        <a href="<?php echo base_url("RoughPurchase/get_addfrm")?>"><button type="button" class="btn btn-primary waves-effect waves-light" >Add Purchase</button></a>
                        <hr />
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $('#datatable-buttons').DataTable({
          ...
          dom: 'Blfrtip',                      
          ajax: {
                 "url": "<?php echo base_url('RoughPurchase/getLists/'); ?>",
                 "type": "POST",
             }, 
       ...
       $('#datatable-buttons').on('click', '[data-id=delete]', function () {                        
            ...
            swal({
                ...
                $.ajax({
                  type: "POST",
                  url: "<?php echo base_url('RoughPurchase/invoice_delete/');?>"+id+"",
