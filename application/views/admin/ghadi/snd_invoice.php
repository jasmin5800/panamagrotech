               ...
               <div class="card-box">
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <h4 class="m-t-0 header-title m-b-30 text-right"><?php echo $ghadi->process_name;?> CHALLAN</h4>
                            </div>
                        </div>
                    </div>
                                ...
                                <table class="table table-borderless">
                                    <tbody>
                                        <tr>
                                          ...
                                          <td> <?php echo $ghadi->challan_no; ?></td>
                                        </tr>
                                        <tr>
                                            <th>DATE</th>
                                            <td><?php echo date('d/m/Y', strtotime($ghadi->date)); ?></td>
                                        </tr>
                                        <tr>
                                            <th>VEHICLE </th>
                                            <td><?php echo $ghadi->vahicle; ?></td>
                                        </tr>
                                        <tr>
                                            <th>VEHICLE NO</th>
                                            <td><?php echo $ghadi->vahicle_no; ?></td>
                                        </tr>    
                                  </tbody>
                              </table>
                            </div>
                    ...
                    <div class="col-md-12 divscroll">
                        <table class="table text-center table-bordered restable" width="100%">
                            ...
                            <tr>
                                ...
                                <th class="header-title">N DESIGN</th>
                                ...
                                <?php echo (($ghadi->child_sb=="B" )?'<th class="header-title">E NAME</th>':""); ?>  
                              </tr>
                            </thead>
                            <tbody>
                                <?php $i=1; foreach ($ghadi_lot as $key => $value): ?> 
                                <tr>
                                   <td class="header-title"><?php echo $i;?></td>
                                   <td class="header-title"><?php echo $value->design_no; ?></td>
                                   <td class="header-title"><?php echo $value->n_design; ?></td>
                                   ...
                                   <td class="header-title"><?php echo $value->dmg_pcs; ?></td>
                                   <td class="header-title"><?php echo $value->patla_name;?></td>
                                   <?php echo (($ghadi->child_sb=="B" )?'<td class="header-title">'.$value->em_name.'</td>':""); ?> 
                                </tr>
                                <?php $i++; endforeach; ?>
                            </tbody>
                      </table>        
                        ...
                        <div class="col-md-6">
                          <table class="table custom-table m-b-0">
                              <tr>
                                  ...
                                  <td><?php echo LOT.$ghadi->lot_no; ?></td>
                              </tr>
                              <tr>
                                  <th style="width:50%">M PCS </th>
                                  <td><?php echo $ghadi->t_missprint; ?></td>
                              </tr>
                              <tr>
                                  <th style="width:50%">GHAT SAREE</th>
                                  <td><?php echo $ghadi->t_ghatsaree; ?></td>
                              </tr>
                              <tr>
                                  <th style="width:50%">REMARK</th>
                                  <td><?php echo $ghadi->remark; ?></td>
                              </tr>
                          </table>
                              ...
                              <table width="100%" >
                                  <tbody>
                                      <tr>
                                          ...
                                          <td><?php $val1= $balance->process_val*$ghadi->t_pcs; echo number_format($val1,2);?></td>
                                      </tr>
                                      <tr>
                                          <td width="60%" style="padding-left:5px;">Job Work Value</td>
                                          <td width="30%" style="border-bottom: 1px solid black;"><?php $val2=$ghadi->g_total; echo number_format($val2,2); ?></td>
                                      <td width="10%"></td>
                                      </tr>
                                      <tr>
                        ...
                        <div class="offset-md-2 col-md-4">
                            <table class="table custom-table">
                                <tr>
                                    ...
                                    <td><?php echo $ghadi->t_design; ?></td>
                                </tr>
                                <tr>
                                    <th style="width:50%">TOTAL PCS</th>
                                    <td><?php echo $ghadi->t_pcs; ?></td>
                                </tr>
                                <tr>
                                    <th>SUB TOTAL</th>
                                    <td><i class="fa fa-inr"></i> <?php echo number_format($ghadi->sub_total,2); ?></td>
                                </tr>
                                <tr>
                                    <th>SGST <?php echo TAX/2; ?>%</th>
                                    <td><i class="fa fa-inr"></i> <?php echo number_format($ghadi->tax/2,2); ?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th>GRAND TOTAL</th>
                                    <td><i class="fa fa-inr"></i> <?php echo number_format(round($ghadi->g_total),2); ?></td>
                                </tr>
                            </table>
                        </div>
                   </div>
