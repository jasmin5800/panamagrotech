    ...
    <div class="container-fluid">
            ...
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <ol class="breadcrumb float-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo base_url('Ghadi/index');?>"><?php echo $page_title; ?></a></li>
                    </ol>
        ...
        <div class="row">
            <div class="col-xs-12 col-md-12">
                <div class="card-box">
                    <h4 class="m-t-0 header-title text-center">Add Ghadi</h4><br>
                    <form action="<?php echo base_url('Ghadi/create');?>" method="post"  class="form-horizontal" >
                        <div class="row">
                          <div class="col-md-3">
                              ...
                              <div class="form-group row">
                                  ...
                                  <div class="col-8">
                                      <select name="child_sb" required class="xSub_Process">
                                        <option value="0">NONE</option>
                                        <option value="A">PRINTING</option>
                                        <option value="B">EMBROIDERY</option>
                                        <option value="C">SELF GHADI</option>
                                      </select>
                                  </div>
                              </div>
                          </div>
                      ...
                      <div class="row m-t-50">
                          <div class="col-lg-12">
                              <div style="overflow-x:auto; ">
                                <table class="table" id="myTable" style="min-width: 1080px;">
                                  <thead>
                                      <tr>
                                        <th scope="col" width="12%">DESIGN NO</th>
                                        <th scope="col" width="12%">PATLA</th>
                                        <th scope="col" width="12%">EM NAME</th>
                                        <th scope="col">N DESIGN</th>
                                        <th scope="col">COLOR</th>
                                        <th scope="col">PCS</th>
                                        <th scope="col">DMG PCS</th>
                          ...
                          <div class="col-md-4">
                              ...
                              <div class="form-group row">
                                  <label for="name" class="col-4 col-form-label">GHADI VAL</label>
                                  <div class="col-8">
                                      <input placeholder="GHADI VAL"  type="number" step="any" 
                                      name="ghadi_val" class="form-control xProcess_value" required readonly autocomplete="off">
                                  </div>
                              </div>
                              <div class="form-group row">
...
$(document).ready(function() {
    ...
    let selfghadi=$('.custom-ghadi').html();
    $('.custom-ghadi').empty();
    var i=2;
    ...
    $('body').on('change','.xSub_Process', function(){
          ...
          $(this).focus();
          $.ajax({
              url: "<?php echo base_url('Ghadi/get_design'); ?>",
              type: "POST",
              data:data,          
    ...
    $('body').on('change','.sDesign', function(){
          ...
          obj.find('.sNdesign').attr('readonly','readonly');
          ...
          $.ajax({
              url: "<?php echo base_url('Ghadi/design_row'); ?>",
              type: "POST",
              data:data,          
              success: function(data){
                var data  = JSON.parse(data);                                          
...
function validateForm(){
  ...
  if(child_sb == "C"){
    ...
    let missprint=parseInt($('.xMissPrint').val());
    let ghat_saree=parseInt($('.xT_Gsaree').val());
    let total_pcs=t_pcs+ghat_saree+missprint;
