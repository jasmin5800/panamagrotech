                              ...
                              <div class="form-group row">
                                 <label for="invoice_no" class="col-3 col-form-label">Invoice No</label>
                                     <div class="col-9">
                                        ...
                                        <input type="hidden" class="form-control"  title="Invoice No" name="bill_typo" placeholder="Invoice No." value="g" required >
                                     </div>
                              </div>
                              <div class="form-group row">
                                    ...
                                    <table class="table" id="mastertbl" style="min-width: 1080px;">
                                        ...
                                        <tbody>
                                          ...
                                          <tr>
                                              ...
                                              <td>
                                                  <input type="number" name="mn_weight[]" class="form-control mNet_W"  placeholder="NET W." required  value="<?php echo $rough_item->n_weight; ?>" 
                                                  step="any" />
                                              </td>


                                              <td>
                                                  <input type="number" name="ghat[]" class="form-control mGhat"  placeholder="GHAT" required  value="<?php echo $rough_item->ghat; ?>" step="any" />
                                              </td>
                                              <td>
                                                  <input type="number" name="ghatweight[]" class="form-control mghat_Weight"  placeholder="weight"  value="<?php echo $rough_item->ghatweight; ?>" step="any" />
                                              </td>
                                              
                                              <td>
                                                  <input type="number" name="mtouch[]" class="form-control mTouch"  placeholder="TOUCH" value="<?php echo $rough_item->touch; ?>" step="any" />
                                                  <input type="hidden" name="mwastage[]" class="form-control mWastage"  placeholder="WASTAGE"  value="0" step="any" />
                                                  <input type="HIDDEN" name="mtouch_wastage[]" class="form-control mT_G"  placeholder="WASTAGE"  value="0" step="any" />
                                              </td>         
                                          ...
                                          <?php $j++; endforeach; endif; ?>
                                            <tr id="xMsaterTr">
                                              ...
                                              <td>
                                                  <input type="number" name="ghat[]" class="form-control mGhat" readonly  placeholder="GHAT" required step="any"/>
                                              </td>

                                              <td>
                                                  <input type="number" name="ghatweight[]" class="form-control mghat_Weight" readonly  placeholder="weight" required step="any"/>
                                                  <input type="hidden" name="mwastage[]" class="form-control mWastage"  placeholder="WASTAGE"  value="0" step="any" />
                                                  <input type="HIDDEN" name="mtouch_wastage[]" class="form-control mT_G"  placeholder="WASTAGE"  value="0" step="any" />
                                           
                                              </td>
                                              <td>
                                                  <input type="number" name="mtouch[]" class="form-control mTouch"  placeholder="TOUCH" step="any" />
                                              </td>
...
<script src="<?php echo base_url('assets/admin/custom/roughinvoiceghat.js');?>"></script>