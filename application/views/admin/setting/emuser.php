<div class="content">
    <div class="container-fluid">
            ...
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <ol class="breadcrumb float-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo base_url('EmUser/index');?>"><?php echo $page_title; ?></a></li>
                    </ol>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card-box">
                    <center><h4 class="header-title m-t-0"><?php echo (($method=="edit")?"Update Em User":"Add Em User" )?></h4></center><br>
                    <form id="<?php echo (($method=="edit")?"$frm_id":"$frm_id");?>" class="form-horizontal" role="form" >
                          <div class="form-group row">
                              <label for="name" class="col-3 col-form-label">EM USER NAME<span class="text-danger">*</span></label>
                              <div class="col-9">
                                  <input placeholder="EM USER NAME" type="text" name="name" required="" class="form-control" autocomplete="off" value="<?php echo (($method=="edit")?$result->em_name:"");  ?>">
                              </div>
                          </div>
                        <?php if($method=="edit"): ?> 
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                ...
                                <?php echo (($method=="edit")?'<input type="hidden" name="id" value="'.$result->emuser_id .'">':""); ?>
                            </div>
                        </div>
                        <?php endif; ?>
    ...
    $(document).ready(function() {
      ...
      <?php if($method !="edit") :?>
        var table = $('#datatable-buttons').DataTable({
            ...
            dom: 'Blfrtip',
            ajax: {
                   "url": "<?php echo base_url('EmUser/getLists/'); ?>",
                   "type": "POST",
               },
      ...
      <?php endif; ?>
       $('#datatable-buttons').on('click', '[data-id=delete]', function () {                        
            ...
            swal({
                ...
                $.ajax({
                  type: "POST",
                  url: "<?php echo base_url('EmUser/delete/');?>"+id+"",
        ...
        $("#Add_frm").submit(function(event){
           ...
           $.ajax({
               url: "<?php echo base_url('EmUser/create')?>",
               type: "POST",
               data: data,              
        ...
        $("#Edit_frm").submit(function(event){
           ...
           var data=$(this).serialize();            
           $.ajax({
               url: "<?php echo base_url('EmUser/update')?>",
               type: "POST",
               data: data,              
               success: function(result){
                   var result  = JSON.parse(result);
                   if(result.status=="success"){
                       swal("success",result.msg,"success","#4fa7f3").then(function () { 
                        window.location="<?php echo base_url("EmUser");?>";            
                   });
                   }else{
                       swal("error",result.msg,"warning","#4fa7f3");
                   }
