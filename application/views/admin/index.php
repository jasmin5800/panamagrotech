          ...
          <?php unset($_SESSION['note_msg']); unset($_SESSION['status']); unset($_SESSION['class']); endif;?>
           ...
           <?php if($_SESSION['auth_role_id'] =="1"): ?>
            <div class="row">
               <div class="col-xl-3 col-sm-6">
                   <div class="card-box widget-box-two widget-two-custom">
                       <div class="text-center"><a class="" href="<?php echo base_url('RoughInvoice/get_addfrmghat');?>"><button type="button" class="btn btn-danger waves-effect waves-light">JAVAK GHAT</button></a></div>
                       <br>
                       <div class="text-center"><a class="" href="<?php echo base_url('RoughInvoice/get_addfrm');?>"><button type="button" class="btn btn-danger waves-effect waves-light">JAVAK WASTAGE</button></a></div>
                      <br>
                      <div class="text-center"><a class="" href="<?php echo base_url('RoughPurchase/get_addfrm');?>"><button type="button" class="btn btn-dark waves-effect waves-light">AAVAK</button></a></div>
                   </div>
               </div>
               <div class="col-xl-3 col-sm-6">
                   <div class="card-box widget-box-two widget-two-custom">
                   ...
                   <br>
                   <div class="text-center"><a class="" href="<?php echo base_url('Garanu/get_addfrm');?>"><button type="button" class="btn btn-danger waves-effect waves-light">GARANU</button></a></div>
                  </br>
               ...
               <div class="col-xl-3 col-sm-6">
                   <div class="card-box widget-box-two widget-two-custom">
                       <div class="text-center"><a class="" href="<?php echo base_url('RoughPayment/fine_ledger');?>"><button type="button" class="btn btn-danger waves-effect waves-light">PARTY TAREEJ</button></a></div>
                       <br>
                       <div class="text-center"><a class="" href="<?php echo base_url('RoughPayment/daily/rs');?>"><button type="button" class="btn btn-dark waves-effect waves-light">RS DAILY ROJMED</button></a></div>
                       <br>
                       <div class="text-center"><a class="" href="<?php echo base_url('RoughPayment/daily/fine');?>"><button type="button" class="btn btn-dark waves-effect waves-light">FINE DAILY ROJMED</button></a></div>
                   </div>
               </div>
           </div>
           <div class="row">
