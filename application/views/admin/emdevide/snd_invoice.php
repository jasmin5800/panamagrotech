               ...
               <div class="card-box">
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <h4 class="m-t-0 header-title m-b-30 text-right"><?php echo $emdevide->process_name;?> CHALLAN</h4>
                            </div>
                        </div>
                    </div>
                                ...
                                <table class="table table-borderless">
                                    <tbody>
                                        <tr>
                                          ...
                                          <td> <?php echo $emdevide->challan_no; ?></td>
                                        </tr>
                                        <tr>
                                            <th>DATE</th>
                                            <td><?php echo date('d/m/Y', strtotime($emdevide->date)); ?></td>
                                        </tr>
                                        <tr>
                                            <th>VEHICLE </th>
                                            <td><?php echo $emdevide->vahicle; ?></td>
                                        </tr>
                                        <tr>
                                            <th>VEHICLE NO</th>
                                            <td><?php echo $emdevide->challan_no; ?></td>
                    ...
                    <div class="col-md-12 divscroll">
                        <table class="table text-center table-bordered restable" width="100%">
                            ...
                            <tr>
                                ...
                                <?php echo (($emdevide->child_sb=="A" )?'<th class="header-title">PATLA</th>':""); ?>  
                                <th class="header-title">E NAME</th>
                              </tr>
                            </thead>
                            <tbody>
                                <?php $i=1; foreach ($emdevide_lot as $key => $value): ?> 
                                <tr>
                                   ...
                                   <?php echo (($emdevide->child_sb=="A" )?'<td class="header-title">'.$value->patla_name.'</td>':""); ?> 
                        ...
                        <div class="col-md-6">
                          <table class="table custom-table m-b-0">
                              <tr>
                                  ...
                                  <td><?php echo LOT.$emdevide->lot_no; ?></td>
                              </tr>
                          </table>
                          <div class="offset-md-2 col-md-8 m-t-20" style="border: 1px solid black;">
                              <table width="100%" >
                                  <tbody>
                                      <tr>
                                          <td width="60%" style="padding-left:5px;">Input Good Value <?php echo $balance->process_val; ?></td>
                                          <td><?php $val1= $balance->process_val*$emdevide->t_pcs; echo number_format($val1,2);?></td>
                                      </tr>
                                      <tr>
                                          <td width="60%" style="padding-left:5px;">Job Work Value</td>
                                          <td width="30%" style="border-bottom: 1px solid black;"><?php $val2=$emdevide->g_total; echo number_format($val2,2); ?></td>
                                      <td width="10%"></td>
                                      </tr>
                                      <tr>
                        ...
                        <div class="offset-md-2 col-md-4">
                            <table class="table custom-table">
                                <tr>
                                    ...
                                    <td><?php echo $emdevide->t_design; ?></td>
                                </tr>
                                <tr>
                                    <th style="width:50%">TOTAL PCS</th>
                                    <td><?php echo $emdevide->t_pcs; ?></td>
                                </tr>
                                <tr>
                                    <th>SUB TOTAL</th>
                                    <td><i class="fa fa-inr"></i> <?php echo number_format($emdevide->sub_total,2); ?></td>
                                </tr>
                                <tr>
                                    <th>SGST <?php echo TAX/2; ?>%</th>
                                    <td><i class="fa fa-inr"></i> <?php echo number_format($emdevide->tax/2,2); ?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th>GRAND TOTAL</th>
                                    <td><i class="fa fa-inr"></i> <?php echo number_format(round($emdevide->g_total),2); ?></td>
                                </tr>
                            </table>
                        </div>
                   </div>
