    ...
    <div class="topbar-left">
        <a href="<?php echo base_url('dashbord');?>" class="logo">
            <span class="text-left">
                <img src="<?php echo base_url('assets/admin/images/').LOGO_WHITE;?>" alt="" height="40">
            </span>
            <i>
                <img src="<?php echo base_url('assets/admin/images/').LOGO_SIDEBAR;?>" alt="" height="41">
            </i>
        </a>
    </div>
        ...
        <ul class="list-inline float-right mb-0">
            <li class="list-inline-item dropdown notification-list">
                <a class="nav-link dropdown-toggle waves-effect waves-light nav-user" data-toggle="dropdown" href="#" role="button"
                   ...
                   <img src="<?php echo ((isset($_SESSION['auth_image']) && !empty($_SESSION['auth_image']))?(base_url('assets/uploads/profiles/').$_SESSION['auth_image']):base_url('assets/uploads/').USER_LOGO) ;?>" alt="user" class="rounded-circle"> 
                </a>
