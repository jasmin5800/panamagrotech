                                ...
                                <table class="table table-borderless">
                                    <tbody>
                                        <tr>
                                          ...
                                          <td> <?php echo $packing->challan_no; ?></td>
                                        </tr>
                                        <tr>
                                            <th>DATE</th>
                                        ...
                                        <tr>
                                            <th>VEHICLE </th>
                                            <td><?php echo $packing->vahicle; ?></td>
                                        </tr>
                                        <tr>
                                            <th>VEHICLE NO</th>
                                            <td><?php echo $packing->vahicle_no; ?></td>
                                        </tr>    
                                  </tbody>
                              </table>
                            </div>
                        ...
                        <div class="col-md-6">
                          <table class="table custom-table m-b-0">
                              <tr>
                                  ...
                                  <td><?php echo LOT.$packing->lot_no; ?></td>
                              </tr>
                              <tr>
                                  <th style="width:50%">M PCS </th>
                                  <td><?php echo $packing->t_missprint; ?></td>
                              </tr>
                              <tr>
                                  <th style="width:50%">GHAT SAREE</th>
                                  <td><?php echo $packing->t_ghatsaree; ?></td>
                              </tr>
                          </table>
                              ...
                              <table width="100%" >
                                  <tbody>
                                      <tr>
                                          ...
                                          <td><?php $val1= $balance->process_val*$packing->t_pcs; echo number_format($val1,2);?></td>
                                      </tr>
                                      <tr>
                                          <td width="60%" style="padding-left:5px;">Job Work Value</td>
                                          <td width="30%" style="border-bottom: 1px solid black;"><?php $val2=$packing->g_total; echo number_format($val2,2); ?></td>
                                      <td width="10%"></td>
                                      </tr>
                                      <tr>
                        ...
                        <div class="offset-md-2 col-md-4">
                            <table class="table custom-table">
                                <tr>
                                    ...
                                    <td><?php echo $packing->t_design; ?></td>
                                </tr>
                                <tr>
                                    <th style="width:50%">TOTAL PCS</th>
                                    <td><?php echo $packing->t_pcs; ?></td>
                                </tr>
                                <tr>
                                    <th>SUB TOTAL</th>
                                    <td><i class="fa fa-inr"></i> <?php echo number_format($packing->sub_total,2); ?></td>
                                </tr>
                                <tr>
                                    <th>SGST <?php echo TAX/2; ?>%</th>
                                    <td><i class="fa fa-inr"></i> <?php echo number_format($packing->tax/2,2); ?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th>GRAND TOTAL</th>
                                    <td><i class="fa fa-inr"></i> <?php echo number_format(round($packing->g_total),2); ?></td>
                                </tr>
                            </table>
                        </div>
                   </div>
