            ...
            <div class="row">
                <div class="col-12" style="">
                    <div class="card-box table-responsive" style="">
                        <a href="<?php echo base_url("SellInvoice1/get_addfrm")?>"><button type="button" class="btn btn-primary waves-effect waves-light" >Add Invoice</button></a>
                        <hr />
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $('#datatable-buttons').DataTable({
          ...
          dom: 'Blfrtip',                      
          ajax: {
                 "url": "<?php echo base_url('SellInvoice1/getLists/'); ?>",
                 "type": "POST",
             }, 
       ...
       $('#datatable-buttons').on('click', '[data-id=delete]', function () {                        
            ...
            swal({
                ...
                $.ajax({
                  type: "POST",
                  url: "<?php echo base_url('SellInvoice1/delete/');?>"+id+"",
