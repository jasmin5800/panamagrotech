    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xs-12 col-md-12">
                <div class="card-box">
                    <h4 class="m-t-0 header-title text-center">Add Embroidery</h4><br>
                    <form action="<?php echo base_url('Embroidery/create');?>" method="post"  class="form-horizontal" >
                        <div class="row">
                          <div class="col-md-3">
                      ...
                      <div class="row m-t-50">
                          ...
                          <div class="col-md-4">
                              ...
                              <div class="form-group row">
                                  ...
                                  <div class="col-8">
                                      ...
                                      name="embroidery_val" class="form-control xProcess_value" required readonly autocomplete="off">
                                  </div>
                              </div>
                          </div>
                          <div class="offset-md-4 col-md-4">
                              ...
                              <div class="form-group row">
                                  ...
                                  <div class="col-8">
                                      <input placeholder="MACHINE DMG" type="number" name="t_machinedmg" required="" class="form-control xMachine_dmg" readonly autocomplete="off" >
                                  </div>
                              </div>
                              <div class="form-group row">
                                  <label for="name" class="col-4 col-form-label">MISS PCS</label>
                                  <div class="col-8">
                                      <input placeholder="MISS PCS" type="number" name="t_missprint" required class="form-control xMissPrint" readonly autocomplete="off" >
                                  </div>
                              </div>
                              <div class="form-group row">
                                  <label for="name" class="col-4 col-form-label">GHAT SAREE</label>
                                  <div class="col-8">
                                      <input placeholder="MISS PCS" type="number" name="t_ghatsaree" required class="form-control xGhat_sharee" readonly autocomplete="off" >
                                  </div>
                              </div>
                              <div class="form-group row">
...
$(document).ready(function() {
    ...
    $('body').on('change','.xSub_Process', function(){
          ...
          $(this).focus();  
          $.ajax({
              url: "<?php echo base_url('Embroidery/get_design'); ?>",
              type: "POST",
              data:data,          
