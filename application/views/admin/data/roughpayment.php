            ...
            <div class="col-md-4">
                <div class="card-box">
                    ...
                    <form role="form" id="<?php echo (($method=="edit")?"$frm_id":"$frm_id");?>">
                        ...
                        <div class="form-group row">
                            <label for="fine" class="col-4 col-form-label">Fine<span class="text-danger">*</span></label>
                            <div class="col-7">
                                <input type="number" name="fine" placeholder="Fine" autofocus="off" class="form-control" value="<?php echo (($method=="edit")?$payment->fine:"0");?>"  <?php echo (($method=="edit")?$readonly:"");?> required >
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="rs" class="col-4 col-form-label">Rs<span class="text-danger">*</span></label>
                            <div class="col-7">
                                <input type="number" name="rs" placeholder="Rs" autofocus="off" class="form-control" value="<?php echo (($method=="edit")?$payment->rs:"0");?>"  <?php echo (($method=="edit")?$readonly:"");?> required >
                            </div>
                        </div>
                        <div class="form-group row">
