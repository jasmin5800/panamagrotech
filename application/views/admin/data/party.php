            ...
            <div class="col-md-4">
                <div class="card-box">
                  ...
                  <form id="<?php echo (($method=="edit")?"$frm_id":"$frm_id");?>" class="form-horizontal" role="form" >
                      ...
                      <div class="form-group row">
                          <label for="address" class="col-3 col-form-label">Opening Fine</label>
                          <div class="col-9">            
                          <input placeholder="Fine" type="number" name="cfine" title="cfine" class="form-control"  autocomplete="off" value="<?php echo (($method=="edit")?$result->cfine:"");  ?>">
                   </div>          
                      </div>
                      <div class="form-group row">
                          <label for="camount" class="col-3 col-form-label">Opening Amount</label>
                          <div class="col-9">            
                          <input placeholder="Amount" type="number" name="camount" title="camount" class="form-control"  autocomplete="off" value="<?php echo (($method=="edit")?$result->camount:"");  ?>">
                   </div>          
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                          <label for="party_type" class="col-3 col-form-label">Party Type<span class="text-danger"> *</span></label>
                          <div class="col-9">
                            <select class="selectpicker" name="party_type"  data-style="btn-custom">
                            	<option value="0">Vepari</option>
