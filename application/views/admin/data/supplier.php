    ...
    <div class="container-fluid">
            ...
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <ol class="breadcrumb float-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo base_url('Supplier/index');?>"><?php echo $page_title; ?></a></li>
                    </ol>
        ...
        <div class="row">
            <div class="col-md-8 offset-md-1">
                <div class="card-box">
                  <h4 class="header-title m-t-0 text-center m-b-30"><?php echo (($method=="edit")?"Update":"Add")?> Supplier</h4>
                  <form id="<?php echo (($method=="edit")?"$frm_id":"$frm_id");?>" class="form-horizontal" role="form" >
                      <div class="form-group row">
                          <label for="name" class="col-3 col-form-label">Supplier Name<span class="text-danger">*</span></label>
                          <div class="col-9">
                              <input placeholder="Supplier Name" type="text" name="name" title="Supplier Name" required="" data-parsley-required-message="Supplier Name is Required" class="form-control" autocomplete="off" value="<?php echo (($method=="edit")?$result->name:"");  ?>">
                          </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                          ...
                          <?php echo (($method=="edit")?'<input type="hidden" name="id" value="'.$result->id_supplier.'">':""); ?>
                      </div>
                      <?php } ?>
...
<script type="text/javascript">
  ...
  var table = $('#datatable-buttons').DataTable({
          ...
          dom: 'Blfrtip',
          ajax: {
                 "url": "<?php echo base_url('Supplier/getLists/'); ?>",
                 "type": "POST",
             },
