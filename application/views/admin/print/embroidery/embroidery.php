        ...
        <div class="row">
            <div class="col-xl-12 col-md-12">
                <div class="card-box">
                    <div class="row">
                        <div class="col-md-12">
                            <h4 class="m-t-0 m-b-20 header-title text-center">Embroidery</h4>
                        </div>
                        <div class="col-md-12">
                            <form method="get" action="<?php echo base_url("PrintAll/embroidery")?>">
                                <div class="row">
                                    <div class="col-md-6">
                    ...
                    <div class="row m-t-50">
                        <div class="col-md-12 divscroll">
                            <h4 class="m-t-10 header-title text-center">Embroidery  &nbsp;  &nbsp; <?php echo $emuser_name->em_name; ?></h4>
