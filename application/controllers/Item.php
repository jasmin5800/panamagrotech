	...
	function getLists(){
	        ...
	        foreach($Master_Data as $m_data){
	            ...
	            $data[] = 	[$i,	        				
	    					$m_data->name,
	    					$status, 
	    					'<a href="'.base_url('item/get_editfrm/').$m_data->id_item.'"><button type="button" class="btn btn-custom waves-effect waves-light"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a><a href="'.base_url('item/delete/').$m_data->id_item.'"><button type="button" class="btn btn-custom waves-effect waves-light"><i class="fa fa-trash" aria-hidden="true"></i></button></a>'];
	        }
	        $output = array(
	            "draw" => $_POST['draw'],
